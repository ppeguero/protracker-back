...
import { getTasksUser, getTasksWithId, getTasksInfoFull, createTask, updateTaskStatus, getTasks} from '../controllers/tasks.controllers.js'; // Cambiado a tasksController
